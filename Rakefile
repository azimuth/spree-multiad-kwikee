...
desc 'Generate documentation for the multiad_kwikee extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'MultiadKwikeeExtension'
...
desc 'Test the multiad_kwikee extension.'
...
namespace :test do
  desc 'Functional test the multiad_kwikee extension.'
  ...
  desc 'Unit test the multiad_kwikee extension.'
